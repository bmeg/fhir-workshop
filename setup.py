...
setup(
    ...
    name='fhir_workshop',  # Required

    # Versions should comply with PEP 440:
    # https://packaging.python.org/en/latest/single_source_version.html
    version='0.0.0rc1',  # Required

    # This is a one-line description or tagline of what your project does. This
    # corresponds to the "Summary" metadata field:
    # https://packaging.python.org/specifications/core-metadata/#summary
    description='Explore several FHIR use cases.',
    # Optional
    ...
    url='https://github.com/bmeg/fhir-workshop',  # Optional
    ...
    keywords='AnVIL NCPI FHIR',  # Optional
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/bmeg/fhir-workshop/issues',
        'Source': 'https://github.com/bmeg/fhir-workshop/',
    },
)
